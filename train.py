        ...
        for epoch in range(start_epoch, n_epochs):
            ...
            for training_step in range(training_steps_per_epoch):
                ...
                tf.logging.info('Step #%d: accuracy %.2f%%, cross entropy %f' %
                                (epoch * training_steps_per_epoch + training_step, train_accuracy * 100,
                                 cross_entropy_value))
...
image_input = tf.placeholder(tf.float32, [None, *image_size, 3], name='image_input')
...
ckpt_path = train_network(n_epochs=20, start_checkpoint=None)
...
train_network(n_epochs=40, start_checkpoint=ckpt_path)
